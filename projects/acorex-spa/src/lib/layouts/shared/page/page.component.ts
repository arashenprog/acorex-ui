...
@Component({
  ...
  template: `
    <div class="page-content-wrap">
      <div class="ax-page-side-start"> <ng-content select="ax-page-side-start"> </ng-content></div>
       <div class="ax-page-toolbar"> <ng-content select="ax-toolbar"> </ng-content></div>
        ...
        <div class="ax-page-side-end"> <ng-content select="ax-page-side-end"> </ng-content></div>
    </div>`
})
